import 'package:lt/Dio/http_config.dart';
...
//
class HomeDao {
  static Future<HomeDate> fetch() async {
    final response = await HttpRequest.request('ctrip/homeConfig.json');
    if (response != null) {
      return HomeDate.fromJson(response);
    } else {
